...
foreach ($edit_data as $row) :
    ...
    <a href="<?php echo site_url('admin/attendance_report_print_view/' . $department_id . '/' . $year . '/' . $month); ?>" class="btn btn-primary btn-icon icon-left hidden-print">
        <?php echo get_phrase('print_payslip_details'); ?>
        
        <i class="entypo-doc-text"></i>
    </a>
    <a href="<?php echo site_url('admin/attendance_report_print_view/' . $department_id . '/' . $year . '/' . $month); ?>" class="btn btn-primary" target="_blank">
